        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                            ...
                            <div>
                                <div className="relative">
                                    <input
                                        ...
                                        className={`peer w-full px-4 pt-6 pb-2 border rounded-lg text-gray-900 placeholder-transparent focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all ${
                ...
                <p className="mt-6 text-center text-xs text-gray-500">
                    By selecting Agree and continue, I agree to ParkShare's{" "}
                    <a href="#" className="underline hover:text-gray-700">Terms of Service</a>,{" "}
                    <a href="#" className="underline hover:text-gray-700">Payments Terms of Service</a>, and{" "}
